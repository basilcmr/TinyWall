...
namespace TinyWallJellyModeInstaller
{
    public class InstallerForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "FoxWall Jelly Mode Setup (v1.4.10)";
            ...
            {
                Text = "FoxWall Custom Setup (v1.4.10)",
            ...
            {
                Text = "Install or completely remove the custom-themed FoxWall Jelly Mode config (v1.4.10).",
        ...
        private async Task StartInstall()
        {
            ...
            logTextBox.Clear();
            AppendLog("Starting custom FoxWall 1.4.10 installation...");
